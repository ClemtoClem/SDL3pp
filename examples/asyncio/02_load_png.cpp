...
struct Main {
  ...
  static SDL::AppResult Init(Main** m, SDL::AppArgs /*args*/) {
    SDL::SetAppMetadata("Example Asyncio load png",
                        "1.0",
                        "com.example.asyncio-load-png");
    SDL::Init(SDL::INIT_VIDEO);
    *m = new Main();
    return SDL::APP_CONTINUE;
  }

  SDL::Window window{"examples/asyncio/load-png", windowSz};
  ...
  SDL::FRect texture_rects[TOTAL_TEXTURES] = { {116, 156, 408, 167}, {20, 200, 96, 60}, {525, 180, 96, 96}, {288, 375, 64, 64},
  };
  ...
  SDL::AppResult Iterate() {
    ...
    for (size_t i = 0; i < TOTAL_TEXTURES; i++) {
      ...
      renderer.RenderTexture(textures[i], std::nullopt, texture_rects[i]);
    }
