...
struct Main {
  ...
  static SDL::Window InitAndCreateWindow() {
    ...
    return SDL::CreateWindowAndRenderer(
      "examples/renderer/lines", windowSz, 0, nullptr);
  }
  ...
  SDL::AppResult Iterate() {
    ...
    static const SDL_FPoint line_points[] = { {100, 354}, {220, 230}, {140, 230}, {320, 100}, {500, 230}, {420, 230}, {540, 354}, {400, 354}, {100, 354},
    };
    ...
    for (float i = 0; i < 360; i++) {
      ...
      renderer.RenderLine({x, y}, {x + SDL::Sin(i) * size, y + SDL::Cos(i) * size});
    }
