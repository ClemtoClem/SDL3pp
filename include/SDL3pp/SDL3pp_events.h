 ...
 * @sa AddEventWatch
 */
using EventSurfaceFilter = bool(SDLCALL*)(void* userdata, Event* event);
 ...
 * @sa SetEventFilter
 * @sa AddEventWatch
 * @sa EventSurfaceFilter
 */
using EventSurfaceFilterCB = std::function<bool(Event* event)>;
 ...
 * @sa PushEvent
 */
inline void SetEventFilter(EventSurfaceFilter filter, void* userdata) {
 ...
 * @sa SetEventFilter
 */
inline bool GetEventFilter(EventSurfaceFilter* filter, void** userdata) {
 ...
 * PeepEvents().
 *
 * @param filter an EventSurfaceFilter function to call when an event happens.
 * @param userdata a pointer that is passed to `filter`.
 * @throws Error on failure.
 *
 * @threadsafety It is safe to call this function from any thread.
 ...
 * @sa SetEventFilter
 */
inline void AddEventWatch(EventSurfaceFilter filter, void* userdata) {
 ...
 * @sa AddEventWatch
 */
inline void RemoveEventWatch(EventSurfaceFilter filter, void* userdata) {
 ...
 *
 * @param filter the EventSurfaceFilter function to call when an event happens.
 * @param userdata a pointer that is passed to `filter`.
 *
 * @threadsafety It is safe to call this function from any thread.
 *
 ...
 * @sa SetEventFilter
 */
inline void FilterEvents(EventSurfaceFilter filter, void* userdata) {
 ...
 * @sa SetEventFilter
 */
inline void FilterEvents(EventSurfaceFilterCB filter) {
  return FilterEvents(
    [](void* userdata, Event* event) {
      const auto& f = *static_cast<EventSurfaceFilterCB*>(userdata);
      return f(event);
    },
    &filter);
}
