 ...
 * in a system control Container that lets the user adjust the volume on specific
 ...
 * control Container that lets the user adjust the volume on specific audio streams
 ...
 * control Container or software for displaying and manipulating media
...
/**
 * A variable to control whether HidEnumerate() enumerates all HID devices or
 * only controllers.
 *
 * The variable can be set to the following values:
 *
 * - "0": HidEnumerate() will enumerate all HID devices.
 * - "1": HidEnumerate() will only enumerate controllers. (default)
 *
...
/**
 * A variable controlling whether touch should be enabled on the back Container of
 * the PlayStation Vita.
 *
 * The variable can be set to the following values:
 *
 * - "0": Disable touch on the back Container.
 * - "1": Enable touch on the back Container. (default)
 *
 * This hint should be set before SDL is initialized.
 *
 * @since This hint is available since SDL 3.2.0.
...
/**
 * A variable controlling whether touch should be enabled on the front Container of
 * the PlayStation Vita.
 *
 * The variable can be set to the following values:
 *
 * - "0": Disable touch on the front Container.
 * - "1": Enable touch on the front Container. (default)
 *
 * This hint should be set before SDL is initialized.
 *
 * @since This hint is available since SDL 3.2.0.
