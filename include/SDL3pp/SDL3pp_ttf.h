...
#if defined(TTF_PROP_FONT_CREATE_EXISTING_FONT_POINTER)
	constexpr auto CREATE_EXISTING_FONT_POINTER =
		TTF_PROP_FONT_CREATE_EXISTING_FONT_POINTER;
#elif defined(TTF_PROP_FONT_CREATE_EXISTING_FONT)
	constexpr auto CREATE_EXISTING_FONT =
...
struct RendererTextEngine : TextEngine {
	...
	RendererTextEngine(RendererTextEngine&&) noexcept = default;
	
	RendererTextEngine& operator=(RendererTextEngine&&) noexcept = default;
...
constexpr auto RENDERER_POINTER = TTF_PROP_RENDERER_TEXT_ENGINE_RENDERER_POINTER;
